...
public class CreateAdvertCommand implements ActionCommand {
    ...
    public Router execute(RequestContent content) {
        ...
        try {
            advert = advertServiceImpl.createAdvert(carAdParameterMap, accountId);
            account = accountServiceImpl.findAccount(accountLogin);
            List<Advert> listUserAdvert = advertServiceImpl.findAdvertBelongAccount(account);
