...
//    public static final String ATTR_NAME_USER = "user";
    ...
    public static final String ATTR_NAME_ERROR_BIRTHDAY = "incorrectBirthAttr";
    public static final String ATTR_NAME_ERROR_EMAIL = "incorrectEmailAttr";
    public static final String ATTR_NAME_ERROR_TEL = "incorrectTelAttr";
    public static final String ATTR_NAME_PASS_NO_EQUALS_PASS_CONFIRM = "noConfirmPassAttr";
    public static final String ATTR_NAME_BUSY_LOGIN = "busyLoginAttr";
    public static final String ATTR_NAME_LIST_ADVERT = "listAdvertAttr";
...
//    public static final String ATTR_IMG_ALT_LANG = "imgAltLangAttr";
    ...
    public static final String ATTR_CAR_MODEL = "car_model_attr";
    public static final String ATTR_CAR_COLOR = "car_color_attr";
    public static final String ATTR_CAR_BODY = "car_body_attr";
    public static final String ATTR_CAR_PRODUCTION_YEAR = "car_production_year_attr";
    public static final String ATTR_CAR_ENGINE_VOLUME = "car_engine_volume_attr";
    public static final String ATTR_CAR_AT_TYPE = "car_at_type_attr";
    public static final String ATTR_CAR_DRIVEUNIT = "car_driveunit_attr";
    public static final String ATTR_CAR_EQUIPMENT = "car_equipment_attr";
    public static final String ATTR_CAR_MILLAGE = "car_millage_attr";
