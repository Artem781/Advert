...
<div class="container">
    ...
    <form class="form-horizontal" action="do?command=CreateAd" method="POST" enctype="multipart/form-data">
        <fieldset>
            ...
            <!-- Select Basic -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="brand">Выберите марку</label>
                <div class="col-md-4">
            ...
            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="milage">Пробег</label>
                <div class="col-md-4">
                    <input id="milage" name="milage" type="number" placeholder=" " class="form-control input-md"
                           required="">
